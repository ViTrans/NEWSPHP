...
<div class="container">
    <div class="post-header-main">
        <div class="post-item">
            ...
            <div>
                <a href="?url=category.php&id=<?php echo $row['category_id'] ?>" class="post-category"><?php echo $row['category_name'] ?></a>
            </div>
            <h3>
        ...
        <div class="post-list">
            <?php foreach ($resultPostRelated as $key => $value) : ?>
                <div class="post-item">
                    ...
                    <a href="?url=category.php&id=<?php echo $value['category_id'] ?>" class="post-category"><?php echo $value['category_name'] ?></a>
                    <h3>
                        <a href="?url=postDetails.php&id=<?php echo $value['id'] ?>" class="post-title"><?php echo $value['title'] ?></a>
                    </h3>
                    <div class="post-desc">
